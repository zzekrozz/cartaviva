  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Field label="Ciudad / zona"><Input value={data.restaurant.city} onChange={(event) => onChange("city", event.target.value)} placeholder="Marbella, Málaga, Fuengirola..." /></Field>
        <Field label="Tipo de negocio">
          <select value={data.restaurant.businessType} onChange={(event) => onChange("businessType", event.target.value as CartaVivaState["restaurant"]["businessType"])} className="w-full rounded-2xl border border-[#eadfce] bg-[#fffdf9] px-4 py-3 text-sm font-semibold outline-none transition focus:border-[#e85d04] focus:bg-white">
