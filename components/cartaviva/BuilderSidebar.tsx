...
export function BuilderSidebar({ steps, activeStep, onChange }: { steps: BuilderStep[]; activeStep: string; onChange: (id: string) => void }) {
  return (
    <aside className="h-fit rounded-[2rem] border border-[#eadfce] bg-white/90 p-3 shadow-[0_20px_60px_rgba(34,24,18,0.08)] backdrop-blur lg:sticky lg:top-24">
      <div className="rounded-[1.7rem] bg-[#221812] p-4 text-white">
        ...
        <p className="mt-2 text-xs font-semibold leading-5 text-white/60">Edita paso a paso. La vista previa se abre aparte para no estorbar.</p>
      </div>
