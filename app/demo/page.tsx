  ...
  return (
    <main className="min-h-screen bg-[#fffaf3]">
      <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-5">
        <Link href="/" className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-[#221812] shadow-sm">
        ...
        <Link href="/builder" className="inline-flex items-center gap-2 rounded-full bg-[#e85d04] px-4 py-2 text-sm font-black text-white shadow-sm">
          <Pencil size={16} /> Editar demo
        </Link>
      </div>
      <PublicMenuView data={defaultCartaVivaState} />
    </main>
  );
}
