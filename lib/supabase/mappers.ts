...
export function stateFromRows(
  ...
  landingRow?: Record<string, any> | null
): CartaVivaState {
  ...
  return normalizeState({
    ...
    translations,
    landing: landingRow ? {
      enabled: landingRow.enabled ?? false,
      heroTitle: landingRow.hero_title || "",
      heroSubtitle: landingRow.hero_subtitle || "",
      storyTitle: landingRow.story_title || "",
      storyText: landingRow.story_text || "",
      galleryImages: landingRow.gallery_images || [],
      featuredProductIds: landingRow.featured_product_ids || [],
      googleMapsUrl: landingRow.google_maps_url || "",
      googleReviewsUrl: landingRow.google_reviews_url || "",
      reservationUrl: landingRow.reservation_url || "",
