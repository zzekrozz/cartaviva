...
export type MenuGroup = "comida" | "bebidas" | "vinos" | "desayunos" | "especial";
...
export const STORAGE_KEY = "cartaviva-builder-state-v2";
...
export const menuGroupOptions: { value: MenuGroup; label: string }[] = [
  ...
  { value: "especial", label: "Menú del día" }
];
...
export const defaultCartaVivaState: CartaVivaState = {
  ...
  categories: [
    { id: "daily", name: "Menú del día", visible: true, order: 0, group: "especial" },
    { id: "tapas", name: "Tapas", visible: true, order: 1, group: "comida" },
    { id: "meats", name: "Carnes", visible: true, order: 2, group: "comida" },
    { id: "fish", name: "Pescados", visible: true, order: 3, group: "comida" },
    { id: "desserts", name: "Postres", visible: true, order: 4, group: "comida" },
    { id: "drinks", name: "Bebidas", visible: true, order: 5, group: "bebidas" }
  ],
  products: [
    {
      id: "p1",
    ...
    },
    {
      ...
      categoryId: "drinks",
      name: "Café solo",
      description: "Café intenso servido al momento. Ideal para cerrar la comida.",
      price: "1,40 €",
      imageUrl: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=900&auto=format&fit=crop",
      tags: [],
      allergens: [],
      status: "active"
    },
