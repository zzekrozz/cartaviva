...
export type Restaurant = {
  ...
  description: string;
  city: string;
  businessType: "Restaurante" | "Bar" | "Cafetería" | "Brunch" | "Tapas" | "Otro";
  logoUrl: string;
  coverUrl: string;
  whatsapp: string;
  phone: string;
...
export const defaultLanding: RestaurantLanding = {
  enabled: false,
  heroTitle: "",
  heroSubtitle: "",
  storyTitle: "",
...
export const templateOptions: {
  ...
  },
  {
    value: "sweet-cafe",
    label: "Dulce Café",
    description: "Luminosa y dulce. Ideal para cafeterías, brunch, pastelerías y heladerías con fotos.",
  },
];
...
export const planOptions: { value: PlanTier; label: string }[] = [
  ...
  { value: "restaurant-pro", label: "Restaurante Web" },
];
...
export function normalizeState(state: CartaVivaState): CartaVivaState {
  return {
    ...
    landing: { ...defaultLanding, ...(state.landing || {}) },
